...
# remove species that were not finally selected

# Charadrius morinellus, Gelochelidon nilotica, Oenanthe leucura, Saxicola dacotiae

trait_data <- trait_data[trait_data$binomial != "Eudromias morinellus" &
                           trait_data$binomial != "Gelochelidon nilotica" &
                           trait_data$binomial != "Oenanthe leucura" &
                           trait_data$binomial != "Saxicola dacotiae",]
...
sp_tax <- sp_tax[sp_tax$binomial != "Eudromias morinellus" &
                   sp_tax$binomial != "Gelochelidon nilotica" &
                   sp_tax$binomial != "Oenanthe leucura" &
                   sp_tax$binomial != "Saxicola dacotiae",]
